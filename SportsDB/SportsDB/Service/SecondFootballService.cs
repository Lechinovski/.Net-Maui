...
{
    public class SecondFootballService : SecondApiFootballService
    {
        ...
        public async Task<List<SecondApiFootball>> ObterLeagues(string country_id)
        {
            ...
            var footballData = JsonSerializer.Deserialize<List<SecondApiFootball>>(nodos.ToString());
            return footballData;
        }
    }
}
